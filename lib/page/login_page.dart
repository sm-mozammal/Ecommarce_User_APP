...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      //backgroundColor: Theme.of(context).primaryColor.withAlpha(a),
      body: Center(
        child: Form(
          key: formKey,
          child:
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: const Text('Click Here', style: const TextStyle(color: Colors.black),),
                      )
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: const Text('REGISTER', style: const TextStyle(color: Colors.blueAccent),),
                      )
                    ],
                  ),
